package chapterTwo.assignments;/* (Diameter, Circumference and Area of a Circle) Here’s a peek ahead. In this chapter, you
...
value that will be output in a System.out.printf statement. The values produced by the circumference and area calculations 
are floating-point numbers. Such values can be output with the format specifier %f in a System.out.printf statement. */
...
public class Circle{
	...
	public static void main(String[] args){
		...
		System.out.printf("The diameter of the circle = %d%n", 2*r);
		System.out.printf("The circumference of the circle = %.6f%n", 2*pi*r);
		System.out.printf("The area of the circle = %.6f%n", pi*r*r);
